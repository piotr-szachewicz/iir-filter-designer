...
public abstract class AbstractIIRDesigner {
	 ...
	 * @return coefficients of the filter which meets the given specification
	 */
	public FilterCoefficients designDigitalFilter(double samplingFrequency, FilterType type, double[] passb, double[] stopb, double gpass, double gstop) throws BadFilterParametersException {
